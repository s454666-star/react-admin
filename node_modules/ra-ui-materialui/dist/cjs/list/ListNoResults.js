...
var ListNoResults = function () {
    ...
    var _a = (0, ra_core_1.useListContext)(), filterValues = _a.filterValues, setFilters = _a.setFilters;
    return (React.createElement(material_1.CardContent, null,
        React.createElement(material_1.Typography, { variant: "body2" }, filterValues && Object.keys(filterValues).length > 0 ? (React.createElement(React.Fragment, null,
