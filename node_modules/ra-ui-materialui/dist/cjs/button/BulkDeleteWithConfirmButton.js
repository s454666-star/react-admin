...
var BulkDeleteWithConfirmButton = function (props) {
    var _a = props.confirmTitle, confirmTitle = _a === void 0 ? 'ra.message.bulk_delete_title' : _a, _b = props.confirmContent, confirmContent = _b === void 0 ? 'ra.message.bulk_delete_content' : _b, _c = props.confirmColor, confirmColor = _c === void 0 ? 'primary' : _c, _d = props.icon, icon = _d === void 0 ? defaultIcon : _d, _e = props.label, label = _e === void 0 ? 'ra.action.delete' : _e, _f = props.mutationMode, mutationMode = _f === void 0 ? 'pessimistic' : _f, _g = props.mutationOptions, mutationOptions = _g === void 0 ? {} : _g, _h = props.successMessage, successMessage = _h === void 0 ? 'ra.notification.deleted' : _h, onClick = props.onClick, rest = __rest(props, ["confirmTitle", "confirmContent", "confirmColor", "icon", "label", "mutationMode", "mutationOptions", "successMessage", "onClick"]);
    var mutationMeta = mutationOptions.meta, otherMutationOptions = __rest(mutationOptions, ["meta"]);
    var _j = (0, ra_core_1.useListContext)(), selectedIds = _j.selectedIds, onUnselectItems = _j.onUnselectItems;
    var _k = (0, ra_core_1.useSafeSetState)(false), isOpen = _k[0], setOpen = _k[1];
    ...
    var _l = (0, ra_core_1.useDeleteMany)(resource, { ids: selectedIds, meta: mutationMeta }, __assign({ onSuccess: function () {
            refresh();
            ...
            setOpen(false);
        }, mutationMode: mutationMode }, otherMutationOptions)), deleteMany = _l[0], isPending = _l[1].isPending;
