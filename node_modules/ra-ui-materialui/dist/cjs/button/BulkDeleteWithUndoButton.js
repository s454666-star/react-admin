...
var BulkDeleteWithUndoButton = function (props) {
    var _a = props.label, label = _a === void 0 ? 'ra.action.delete' : _a, _b = props.icon, icon = _b === void 0 ? defaultIcon : _b, onClick = props.onClick, _c = props.mutationOptions, mutationOptions = _c === void 0 ? {} : _c, _d = props.successMessage, successMessage = _d === void 0 ? 'ra.notification.deleted' : _d, rest = __rest(props, ["label", "icon", "onClick", "mutationOptions", "successMessage"]);
    var mutationMeta = mutationOptions.meta, otherMutationOptions = __rest(mutationOptions, ["meta"]);
    var _e = (0, ra_core_1.useListContext)(), selectedIds = _e.selectedIds, onUnselectItems = _e.onUnselectItems;
    var notify = (0, ra_core_1.useNotify)();
    var resource = (0, ra_core_1.useResourceContext)(props);
    var refresh = (0, ra_core_1.useRefresh)();
    var _f = (0, ra_core_1.useDeleteMany)(), deleteMany = _f[0], isPending = _f[1].isPending;
