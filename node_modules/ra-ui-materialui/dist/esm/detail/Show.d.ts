...
import { RaRecord, ShowControllerProps } from 'ra-core';
 ...
 */
export declare const Show: <RecordType extends RaRecord<import("ra-core").Identifier> = any>({ id, resource, queryOptions, disableAuthentication, ...rest }: ShowProps<RecordType>) => ReactElement;
export interface ShowProps<RecordType extends RaRecord = any> extends ShowControllerProps<RecordType>, ShowViewProps {
}
