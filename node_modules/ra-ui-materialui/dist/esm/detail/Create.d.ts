...
import { CreateControllerProps, Identifier, RaRecord } from 'ra-core';
...
export interface CreateProps<RecordType extends Omit<RaRecord, 'id'> = any, MutationOptionsError = Error, ResultRecordType extends RaRecord = RecordType & {
    id: Identifier;
}> extends CreateControllerProps<RecordType, MutationOptionsError, ResultRecordType>, CreateViewProps {
}
